...
SimpleDoublerLookAndFeel::SimpleDoublerLookAndFeel()
{

};

void SimpleDoublerLookAndFeel::drawRotarySlider(Graphics& g, int x, int y, int width, int height, float sliderPos,
